...
If I could offer one piece of advice to newcomers (as a rookie myself), it would be this: take breaks when you need to. It's easy to feel overwhelmed, but avoiding burnout is crucial for long-term progress. For those just getting started in the labs, the Academy provides a structured learning style that’s perfect for beginners, making it easier to ease into the material.

Looking ahead, I am focused on building deep, professional expertise in cybersecurity. I find that consistent practice with HTB Academy and its labs is an effective way to work toward that goal. Completing various paths, like the SOC analyst and penetration tester tracks, makes the learning process engaging and enjoyable. The gamified experience keeps me looking forward to studying, which is a huge plus!
